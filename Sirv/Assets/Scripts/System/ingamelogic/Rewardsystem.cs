...
public class Rewardsystem : MonoBehaviour
{
    ...
    void SetStatText()
    {
        ...
        스탯.text += ((int)(player.armor * 1)).ToString();
        스탯.text += "</color><br>";
        ...
        스탯.text += ((int)(player.fireCount * 1)).ToString();
        스탯.text += "</color><br>";
        ...
        스탯.text += ((int)(player.reloadtimePer * 100)).ToString();
        스탯.text += "</color><br>";
        ...
        스탯.text += ((int)(player.BloodSuck * 100)).ToString();
        스탯.text += "</color><br>";
    }
